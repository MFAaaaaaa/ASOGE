    ...
    def train(self):
        ...
        for i in range(epochs):
            ...
            for j, (img_data, img_label, ind) in enumerate(train_loader):
                #office datase 需要下面这两行，visda不需要
            ...
            if acc >= best_acc:
                ...
                torch.save(net, './model_source/' + time_stamp_launch + '-' + dataset_name +'9_1_resnet101_best.pkl')
                best_acc = acc
            else:
                torch.save(net, './model_source/' + time_stamp_launch + '-' + dataset_name +'9_1_resnet101_last.pkl')
